  ...
  return (
    <div className="h-full overflow-auto" ref={scrollRef}>
      <div className="flex flex-col min-w-max">
        ...
        {/* ── Room headers row: sticky within the scroll container, scrolls
             horizontally in sync with the columns since it's part of the
             same scrolled content ── */}
        <div className="flex flex-shrink-0 sticky top-0 z-10 bg-surface border-b border-border">
