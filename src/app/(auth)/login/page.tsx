    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 bg-surface-2">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-text-primary">musicmaker</h1>
          <p className="text-sm text-text-secondary mt-1">Musikschafferei · Linz</p>
        </div>
        ...
        <div className="mt-5 text-center space-y-2">
          ...
          <Link
            ...
            className="block text-sm text-text-tertiary hover:text-text-secondary"
          >
            Passwort vergessen?
          </Link>
        </div>
